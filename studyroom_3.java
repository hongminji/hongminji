...
public class studyroom_3{
	JFrame jFrame = new JFrame("3층 성인전용열람실");
	JButton[] btn1 = null;
	...
	public studyroom_3(){
		...
		JLabel leftseat_1 = new JLabel("3층 성인전용 열람실 잔여좌석");
		...
		String j = Integer.toString((temp1.getstudyroom_3()));
		JLabel leftseat_F = new JLabel(j);
		btn1 = new JButton[51]; // jbButton 버튼 배열 초기화
