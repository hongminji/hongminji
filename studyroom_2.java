...
public class studyroom_2{
	JFrame jFrame = new JFrame("2층 남성전용열람실");
	JButton[] btn1 = null;
	...
	public studyroom_2(){
		...
		JLabel leftseat_1 = new JLabel("2층 남성전용 열람실 잔여좌석");
		...
		String j = Integer.toString((temp1.getstudyroom_2()));
