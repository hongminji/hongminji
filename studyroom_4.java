...
public class studyroom_4{
	JFrame jFrame = new JFrame("4층 노트북전용열람실");
	JButton[] btn1 = null;
	  static studyroomseat a = new studyroomseat(); 
			public static int studyroom_1 = a.studyroom_1;
			public static int studyroom_2 = a.studyroom_2;
			public static int studyroom_3 = a.studyroom_3;
			public static int studyroom_4 = a.studyroom_4;
	...
	public studyroom_4(){
		...
		JLabel leftseat_1 = new JLabel("4층 노트북전용 열람실 잔여좌석");
		...
		String j = Integer.toString(temp1.getstudyroom_4());
		JLabel leftseat_F = new JLabel(j);
		btn1 = new JButton[41]; // jbButton 버튼 배열 초기화
		...
		public void actionPerformed(ActionEvent e) {
			...
			for(int i=1;i<=30;i++){
				if(e.getSource()== btn1[i]){
					...
					System.out.println(studyroom_4);
